    ...
    <section class="checkbox">
        ...
        <div class="slide-verify" id="slideVerify" onselectstart="return false;">
            <div 
                ...
                style="width: 100%">
            >
                <canvas :width="w" :height="h" ref="canvas" class="canvas_cover"></canvas>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 随机生成img src
            getRandomImg() {
                return 'https://picsum.photos/720/420/?image=' + this.getRandomNumberByRange(0, 1084);
            },
...
<style lang="scss">
    ...
    .slide-verify-refresh-icon {
        ...
        height: 34px;
        cursor: pointer;
        background: url('../../assets/icon.png') 0 -437px;
    ...
    .slide-verify-slider-mask-item-icon {
        ...
        width: 14px;
        height: 12px;
        background: url('../../assets/icon.png') 0 -26px;
        background-size: 34px 471px
    }
    ...
    .container-success .slide-verify-slider-mask-item {
        height: 38px;
        top: -1px;
        border: 1px solid rgb(82, 204, 102);
        background-color: rgb(82, 204, 102) !important;
    }
